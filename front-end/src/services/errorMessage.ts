...
const errorMessages: Record<string, string> = {
  ...
  INVOICE_NOT_DRAFT: 'Only draft invoices can be changed, issued, or deleted.',
  INVOICE_HAS_PAYMENTS: 'This invoice has payment activity and cannot be deleted. Void it instead.',
