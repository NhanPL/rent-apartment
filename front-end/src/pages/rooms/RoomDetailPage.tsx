import { ArrowLeftOutlined, DeleteOutlined, EditOutlined, ExclamationCircleOutlined, PlusOutlined } from '@ant-design/icons'
import { Button, Card, Descriptions, Empty, Grid, Skeleton, Space, Table, Tag, Typography, message, Modal } from 'antd'
                  ...
                  <Button
                    ...
                    onClick={() =>
                      Modal.confirm({
                        ...
                        okButtonProps: { danger: true },
                        onOk: async () => {
                          await deleteMonthlyBill(record.id)
                          await refresh()
